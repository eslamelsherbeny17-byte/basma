...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Top Banner - يظهر على جميع الأحجام لكن بحجم أصغر على الموبايل */}
            ...
            <div className='flex items-center justify-center'>
              ...
              >
                ...
                >
                  ...
                  <span className='xs:hidden'>خصم 20%</span>
                </motion.span>
              </motion.div>
            </div>
          </div>
          ...
          <div className='container mx-auto px-4'>
            <div className='flex h-14 sm:h-16 md:h-18 items-center justify-between'>
              ...
              <div className='flex items-center gap-1 lg:gap-2'>
                  ...
                  {isAuthenticated ? (
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant='ghost'
                          size='icon'
                          className='h-10 w-10 rounded-full hover:bg-primary/15'
                        >
                    ...
                    <Link href='/login'>
                      <Button
                        variant='ghost'
                        size='icon'
                        className='h-10 w-10 rounded-full hover:bg-primary/15 hover:text-primary'
                      >
                ...
                {/* Wishlist */}
                <Link href='/wishlist'>
                  <Button variant='ghost' size='icon' className='relative h-9 w-9 sm:h-10 sm:w-10 rounded-xl hover:bg-primary/15 hover:text-primary transition-all'>
                ...
                {/* Cart */}
                <Button variant='ghost' size='icon' className='relative h-9 w-9 sm:h-10 sm:w-10 rounded-xl hover:bg-primary/15 hover:text-primary transition-all' onClick={() => setIsCartOpen(true)}>
                    ...
                    <div
                      className={cn(
                        ...
                        isActive
                          ...
                          : 'hover:bg-muted/80 font-semibold',
                        link.special &&
